...
CMD_HELP.update(
    {
        "github": "__**NAMA PLUGIN :** Github__\
    \n\n✅** CMD ➥** `.github` USERNAME\
    \n**Fungsi   ➥  **Menunjukkan informasi github tentang nama pengguna yang Anda berikan\
    \n\n✅** CMD ➥** `.commit` balas file python untuk diunggah ke github\
    \n**Fungsi   ➥  **Itu mengunggah file yang diberikan ke repo github Anda(ke userbot/plugins folder)\
    \n\nUntuk bekerja set plugin komit `GITHUB_ACCESS_TOKEN` and `GIT_REPO_NAME` di vars heroku"
    }
)
