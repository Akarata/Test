...
CMD_HELP.update(
    {
        "lydia": "__**NAMA PLUGIN :** Lydia__\
    \n\n✅** CMD ➥** `.enai` <balas ke pengguna>\
    \n**Fungsi   ➥  **bot Anda akan otomatis membalas ke pengguna yang diberi tag sampai Anda menghentikannya by `.remcf`\
    \n\n✅** CMD ➥** `.reai`<balas ke pengguna> \
    \n**Fungsi   ➥  **balas ke pengguna yang ingin Anda nonaktifkan lydia\
    \n\n✅** CMD ➥** `.liai` \
    \n**Fungsi   ➥  **untuk mencantumkan pengguna yang Anda aktifkan ai(lydia)\
    \n\n Untuk memfungsikan plugin ini, Anda perlu mengatur heroku var\
    \n Kuncinya adalah `LYDIA_API_KEY` dan dapatkan var dari [sini](https://coffeehouse.intellivoid.net)"
    }
)
