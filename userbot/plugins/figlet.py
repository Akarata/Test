...
CMD_HELP.update(
    {
        "figlet": "__**NAMA PLUGIN :** Figlet__\
    \n\n✅** CMD ➥** `.figlet` text ** or **`.figlet text :type`\
    \n**Fungsi   ➥  **jenisnya slant, 3D , 5line , alpha , banner ,  doh ,  iso ,  letter , allig , dotm , bubble , bulb , digi\
    \n\n***NOTE: **Tidak ada spasi harus diberikan setelahnya : dan ketik\
    \n**CONTOH :** `.figlet Halo :digi`"
    }
)
