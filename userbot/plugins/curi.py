...
@register(outgoing=True, pattern=r"^\.curi|.curry")
async def kang(args):
    ...
    if photo:
        ...
        await args.edit(
            "`Stiker berhasil di curi :3`"
            f"\nKlik [disini](t.me/addstickers/{packname}) kalo mau liat pack stikerku",
            parse_mode="md",
        )
